function ROCValue=feature_roc(Price,Length)
%----------------------此函数用来计算ROC指标(变动速率)---------------------
%----------------------------------编写者--------------------------------
...
Price(abs(Price)<0.0001)=0.0001;
ROCValue(Length+1:end)=(Price(Length+1:end)-Price(1:end-Length))./Price(1:end-Length);
ROCValue(isnan(ROCValue))=0;
